...
import { ScrollView, Text, StyleSheet, Dimensions, Image, FlatList, Animated } from 'react-native';
...
const About = () => {
	return (
		<ScrollView style={{ width: '95%', marginLeft: '5%', paddingTop: '7%', marginTop: '13%' }}>
			<Text style={{ fontSize: rem * 2, fontWeight: 'bold', marginRight: '5%' }}>
				Balancer
			</Text>
			<Text style={{ fontSize: rem, marginRight: '6%' }}> </Text>
			<Text style={{ fontSize: rem * 1.5, marginRight: '6%' }}>
				License
			</Text>

			<Text style={{ fontSize: rem * 0.8, marginRight: '6%' }}>
				{'\n'}Apache License{'\n'}
			...
			<Text style={{ fontSize: rem * 0.8, marginRight: '6%' }}>
				{'\n'}This application uses open source projects.
				You can find the source code of those projects and license below.
				We acknowledge and are grateful to the developers contributed to those open source projects.
				{'\n\n'}
